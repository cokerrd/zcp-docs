...
This option lets you upgrade or downgrade your VM's resource allocation, such as CPU cores, RAM, and
storage. The plan change process requires a reboot of the VM.
